...
using OrderBentoProject.WriteLog;
using System;
using System.Collections.Generic;
using System.Data;
using System.Data.SqlClient;

namespace OrderBentoProject.Utility
{
    public class DBTool
    {
        //資料庫連結字串
        private string connectionString =
              "Data Source=localhost\\SQLExpress;Initial Catalog=BentoSystem; Integrated Security=true";
        /// <summary>
        ...
        /// <returns></returns>
        public List<User> ChangeTypeUserInfo(DataTable dataTable)
        {
            ...
            try
            {
                foreach (DataRow item in dataTable.Rows)
                {
                    ...
                    if (dataTable.Columns["Privilege"] != null && item["Privilege"] != null)
                        uInfo.Privilege = Convert.ToBoolean(item["Privilege"]);
                    if (dataTable.Columns["UserPic"] != null && item["UserPic"] != null)
                        uInfo.UserPic = item["UserPic"].ToString();
